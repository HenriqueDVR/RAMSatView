...
const DICTIONARY = {
  pt: {
    ...
    "state.generated": "Previsao de {time}",
    "state.age_min": "ha {n} min",
    "state.age_h": "ha {n} h",
    "state.age_d": "ha {n} d",
    "state.stale_note": "sem dados mais recentes",
    ...
    "time.back": "Hora anterior",
    "time.forward": "Hora seguinte",
    "time.to_sunrise": "Ir para o nascer do sol",
    "time.hide": "Esconder o controlo de tempo",
    "time.show": "Mostrar o controlo de tempo",
    "legend.forecast_title": "Topo previsto",
    "legend.observed_title": "Topo observado",
    "legend.observed_scan": "Imagem de {time}",
    "legend.observed_gap_before": "{n} h antes da hora mostrada",
    "legend.observed_gap_after": "{n} h depois da hora mostrada",
    "legend.observed_same": "a hora mostrada",
    "layers.note.cloud": "Modelo, de hora a hora",
    "layers.note.heatmap": "Modelo, de hora a hora",
    "layers.note.observed": "Satelite, de 3 em 3 h, so o passado",
    "sidebar.back": "Todos os locais",
    "sidebar.count": "{n} locais",
    "sidebar.legal": "Fontes e avisos",
    "sheet.open": "Abrir o painel",
    "sheet.close": "Fechar o painel",
  },
  en: {
    ...
    "state.generated": "Forecast from {time}",
    "state.age_min": "{n} min ago",
    "state.age_h": "{n} h ago",
    "state.age_d": "{n} d ago",
    "state.stale_note": "nothing newer has arrived",
    ...
    "time.back": "Previous hour",
    "time.forward": "Next hour",
    "time.to_sunrise": "Jump to sunrise",
    "time.hide": "Hide the time control",
    "time.show": "Show the time control",
    "legend.forecast_title": "Forecast cloud top",
    "legend.observed_title": "Observed cloud top",
    "legend.observed_scan": "Scan from {time}",
    "legend.observed_gap_before": "{n} h before the hour shown",
    "legend.observed_gap_after": "{n} h after the hour shown",
    "legend.observed_same": "the hour shown",
    "layers.note.cloud": "Model forecast, hourly",
    "layers.note.heatmap": "Model forecast, hourly",
    "layers.note.observed": "Satellite, every 3 h, past only",
    "sidebar.back": "All spots",
    "sidebar.count": "{n} spots",
    "sidebar.legal": "Sources and safety",
    "sheet.open": "Open the panel",
    "sheet.close": "Close the panel",
  },
} as const;
